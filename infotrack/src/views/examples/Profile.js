...
const Profile = () => {
  const {obj,handlechange,handlesubmit,fileis,shownav,validval,message,therating,
    response,responseis,handleskilltag,id,objskill,handlerating,success,successis,idchange,logout,auth} = useApi();
                  ...
                  <div className="card-profile-image">
                    <a href="#pablo" onClick={(e) => e.preventDefault()}>
                      <img
                        ...
                        src={
                          'http://anand.dbtechserver.online/ats2/static/media/userimage.6379973e.jpg'
                        }
                      />
                    </a>
                  </div>
