...
const Tables = () => {
  ...
  refFormodal.current.addEventListener('click',(e)=>{
    let t = refer.current && refer.current.contains(e.target)
    if(!t){
      setFilterRating(0)
    }
  })
                        ...
                        <th scope="row">
                          <Media className="align-items-center">
                                ...
                                >
                                  <img
                                    alt="some"
                                    src="http://anand.dbtechserver.online/ats2/static/media/userimage.6379973e.jpg"
                                  />
                                </a>
                                <Media>
